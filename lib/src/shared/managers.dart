...
class WebGlViewProjectionMatrixManager extends Manager {
  ...
  Matrix4 create3dViewProjectionMatrixForPosition(Vector3 position) {
    ...
    setViewMatrix(viewMatrix, new Vector3(position.x, position.y, position.z - 300.0),
        new Vector3(position.x, position.y, position.z + 150.0), new Vector3(0.0, -1.0, 0.0));
    setPerspectiveMatrix(projMatrix, PI / 2, factor, 1.0, 1000.0);
